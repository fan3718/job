...
export default app.controller('QuesController',['$scope','$filter','$location','UserService','ExerciseService','HttpClient',function($scope,$filter,$location,UserService,ExerciseService,HttpClient){
