...
require.config({
    ...
    paths : {
        ...
        MessageController:'modules/student/MessageCtrl',
...
require(['jquery','angular','infinite-scroll','ngFileUpload','UserController','MessageController','NavigatorController','lazyload'],function($,angular){
