...
if(document.createElementNS){
    ...
    ngProgressbar='directives/ng-progressbar2';
}
...
require.config({
    ...
    paths : {
        ...
        ExamController:'modules/student/ExamCtrl',
...
require(['jquery','angular','infinite-scroll','ngSwiper','ngFileUpload','UserController','ExamController','NavigatorController','lazyload'],function($,angular){
