...
require.config({
    ...
    paths : {
        ...
        ReportController:'modules/student/ReportController',
...
require(['jquery','angular','infinite-scroll','ngEcharts','UserController','QuesController','ReportController','lazyload'],function($,angular){
