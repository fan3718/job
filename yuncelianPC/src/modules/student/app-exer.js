...
require.config({
	...
	paths : {
		...
		ExerciseController:'modules/student/ExerciseCtrl',
...
require(['jquery','angular','infinite-scroll','ngFileUpload','UserController','ExerciseController','NavigatorController','lazyload'],function($,angular){
